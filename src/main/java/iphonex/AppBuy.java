...
public class AppBuy extends IPhoneX{
    ...
    public AppBuy(ReqManager reqManager, int id, String[] elementArr){
    ...
    public  void getAddressList(){
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                String result = response.body().string();
                System.out.println("addressList:" + result);
                getAddressAddHtml();
            }
        });
    }
    public  void getAddressAddHtml(){
        ...
        Request request = new Request.Builder()
                .url(url)
                .addHeader("Cookie", getReqCookie())
                .addHeader("Referer", "https://app.10086.cn/leadeon-cmcc-static/v2.0/pages/mall/address/c_addresslist.html")
                .build();
        Call call = okHttpClient.newCall(request);
        call.enqueue(new Callback() {
            @Override
            ...
            public void onResponse(Call call, Response response) throws IOException {
                String result = response.body().string();
                System.out.println("addressAddHtml:" + result);
                addRecvAddrInfo();
            }
        });
    }
    public  void addRecvAddrInfo(){
        String url="https://app.10086.cn/biz-orange/SHG/receiveAdmin/addReceivingAddrInfo?" + getReqCookie();
        url = url.replaceAll(" ", "");
        MediaType mediaType = MediaType.parse("application/x-www-form-urlencoded; charset=UTF-8");
        String data = "{\"cid\":\""+ctid+"\",\"en\":\"0\",\"t\":\""+ getReqCookie() +"\",\"sn\":\"SM-C7000\",\"cv\":\"4.0.0\",\"st\":\"1\",\"sv\":\"6.0.1\",\"sp\":\"1080x1920\",\"xc\":\""+ xc +"\",\"imei\":\""+ imei +"\",\"nt\":\"\",\"sb\":\"\",\"prov\":\"200\",\"city\":\"0755\",\"tel\":\""+ cellNum +"\",\"reqBody\":{\"cellNum\":\""+cellNum+"\",\"provinceCode\":\""+provinceCode+"\",\"cityCode\":\""+cityCode+"\",\"regionCode\":\""+regionCode+"\",\"street\":\""+street+"\",\"zipCode\":null,\"recName\":\""+recName+"\",\"recPhoneNo\":\""+recPhoneNo+"\",\"recTel\":null,\"isDefault\":\"1\"}}";
        ...
        Request request = new Request.Builder()
                            ...
                            .post(requestBody)
                            .addHeader("Cookie", getReqCookie())
                            .addHeader("Referer", "https://app.10086.cn/leadeon-cmcc-static/v2.0/pages/mall/address/c_address_add.html?operator=add&actionPage=&goodsId=&skuId=&num=&payWay=&prodType=&orderPayPrice=&contractId=&contractPhone=&modelIds=&packageModelIds=&recAddrId=&address=&recName=&recPhoneNo=&invoiceId=&invoiceAddr=&invoiceType=")
                            .build();
    ...
    public static void main(String args[]) {
        ...
        String[] elementArr = {"15013894358","ZOqzoAEe9U0KVnOUPK0IFfQRenD9kYL44VxyFPSionPEAMID4D60J9MENvkxRH0gRCWZKF+k22uukP4JTJlME7hm6cVMrgkg5Imow1KxWqrXqPUClS2RhpcnUTjEoSZFelmwTGe+o7kxmfewYdj/ofxtsXd+4EPFZUOGkew965g="};
        AppBuy appBuy = new AppBuy(reqManager,0,elementArr);
        appBuy.onSendMsg();
        appBuy.onLogin();
        appBuy.onBuy("1045210", "1040095");
    }
}